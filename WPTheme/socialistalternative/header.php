...
<html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Coda+Caption:wght@800&family=Work+Sans:ital,wght@0,300;0,400;0,600;0,700;0,800;0,900;1,400;1,700;1,800&display=swap" rel="stylesheet">
        <?php wp_head(); ?>
    </head>
    <body>
